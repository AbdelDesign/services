...
function getIcon(name) {
  const icons = {
    ...
    behance: '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M15.2 9.2a4.8 4.8 0 0 0-4.9-4.9H2v15.5h8.3a4.8 4.8 0 0 0 4.9-4.8v-1.1c0-.6-.5-1.1-1.1-1.1H8.3V9.2h6.9zm-2.1 5.8H8.3v-2.2h4.8v2.2zM18.8 11.2h4.9v1.1h-4.9z"/></svg>'
  };
  return icons[name] || '';
}
...
app.innerHTML = `
  ...
  <nav class="fixed top-0 left-0 right-0 z-50 transition-all duration-300">
      ...
      <div class="glassmorphism border border-light-border dark:border-dark-border px-6 py-3 rounded-full">
        <div class="flex items-center gap-6">
          <a href="#inicio" class="block" aria-label="Abdel Design Home">
            <img src="assets/logo/logo 2.png" alt="Abdel Design Logo" class="h-6 w-auto">
          </a>
    ...
    <div class="md:hidden glassmorphism border-b border-light-border dark:border-dark-border">
      <div class="flex items-center justify-between px-6 py-4">
        <a href="#inicio" class="block" aria-label="Abdel Design Home">
          <img src="assets/logo/logo 2.png" alt="Abdel Design Logo" class="h-8 w-auto">
        </a>
  ...
  <section id="inicio" class="hero-section min-h-screen flex items-center justify-center relative">
    ...
    <div class="relative z-10 text-center px-6 max-w-4xl mx-auto">
      <h1 class="text-4xl md:text-6xl lg:text-7xl font-bold mb-6 text-white">Abdel Design</h1>
    ...
    <div class="max-w-6xl mx-auto">
      <div class="glassmorphism border border-light-border dark:border-dark-border p-8 md:p-12 rounded-3xl animate-fade-in">
        ...
        <p class="text-lg text-light-muted dark:text-dark-muted mb-8 leading-relaxed">
          Somos uma agência criativa especializada em transformar ideias em realidade visual. Com anos de experiência no mercado angolano, oferecemos soluções completas de design gráfico, desenvolvimento web, produção de vídeo e filmagem profissional. A nossa missão é elevar a presença da sua marca através de design excecional e estratégias visuais impactantes.
        </p>
      ...
      <div class="grid md:grid-cols-3 gap-8">
        <div class="border border-light-border dark:border-dark-border p-8 rounded-3xl hover:scale-105 transition-transform duration-300">
          ...
          <p class="text-light-muted dark:text-dark-muted">
            Anos de experiência a criar soluções visuais que geram resultados reais para os nossos clientes.
          </p>
        </div>
        ...
        <div class="border border-light-border dark:border-dark-border p-8 rounded-3xl hover:scale-105 transition-transform duration-300">
          ...
          <h3 class="text-xl font-bold mb-4">Qualidade Premium</h3>
          <p class="text-light-muted dark:text-dark-muted">
        ...
        <div class="border border-light-border dark:border-dark-border p-8 rounded-3xl hover:scale-105 transition-transform duration-300">
          ...
          <p class="text-light-muted dark:text-dark-muted">
            Focamos em criar designs que não só parecem bem, mas também impulsionam o vosso negócio.
          </p>
        </div>
      </div>
    </div>
