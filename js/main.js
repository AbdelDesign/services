  ...
  <nav class="fixed top-0 left-0 right-0 z-50 transition-all duration-300">
      ...
      <div class="glassmorphism border border-light-border dark:border-dark-border px-6 py-3 rounded-full">
        <div class="flex items-center gap-6">
          <a href="#inicio" class="block" aria-label="Abdel Design Home">
            <img src="https://res.cloudinary.com/dstiyz2js/image/upload/v1762598046/logo_pv2bnf.png" alt="Abdel Design Logo" class="h-6 w-auto">
          </a>
    ...
    <div class="md:hidden glassmorphism border-b border-light-border dark:border-dark-border">
      <div class="flex items-center justify-between px-6 py-4">
        <a href="#inicio" class="block" aria-label="Abdel Design Home">
          <img src="https://res.cloudinary.com/dstiyz2js/image/upload/v1762598046/logo_pv2bnf.png" alt="Abdel Design Logo" class="h-8 w-auto">
        </a>
